...
class Calculator:
    def __init__(self, root):
        ...
        # StringVar untuk menampilkan dan menyimpan input
        self.expression = ""
        self.input_text = tk.StringVar()

        # Frame untuk menampilkan layar kalkulator
        input_frame = tk.Frame(self.root, bd=2, relief=tk.RIDGE)
        input_frame.pack(padx=10, pady=10)

        # Entry sebagai layar tampilan
        ...
        # Daftar tombol dalam grid (label, row, col, colspan, rowspan)
        buttons = [
            ("C",  0, 0), ("←",  0, 1), ("(",  0, 2), (")",  0, 3),
    ...
    def on_button_click(self, char):
        ...
        if char == "C":
            ...
            try:
                ...
                self.expression = result  # Memungkinkan kalkulasi beruntun
            except:
                self.input_text.set("Error")
                self.expression = ""
        else:
            # Angka, operator, tanda kurung, atau titik
